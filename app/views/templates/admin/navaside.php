<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="<?= BASE_URL?>/assets/soft-ui/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Kokyo Complaints</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  <?php if ($data['title'] == "Dashboard") {
            echo "active";}?>" href="<?= BASE_URL ?>/admin">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if ($data['title'] == "Pengaduan") {
            echo "active";}?>" href="<?= BASE_URL ?>/admin/pengaduan">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if ($data['title'] == "Petugas") {
            echo "active";}?>" href="<?= BASE_URL ?>/admin/petugas">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><?= $data['title']?></li>
          </ol>
          <h6 class="font-weight-bolder mb-0"><?= $data['title']?></h6>
        </nav>
          ...
          <ul class="navbar-nav  justify-content-end"> 
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><?= $_SESSION['petugas']['name']?></span>
              </a>
            </li>
